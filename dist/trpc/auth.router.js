...
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure.input(account_credentials_validator_1.AuthCredntialValidator).mutation(function (_a) {
        var input = _a.input;
    ...
    signIn: trpc_1.publicProcedure.
        input(account_credentials_validator_1.AuthCredntialValidator)
