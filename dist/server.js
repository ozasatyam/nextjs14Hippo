...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    var webhookMeddleware, payload;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                webhookMeddleware = body_parser_1.default.json({
                    verify: function (req, _, buffer) {
                        req.rowBody = buffer;
                    }
                });
                app.post("/api/webhooks/stripe", webhookMeddleware, webhooks_1.stripeWebhookHandler);
