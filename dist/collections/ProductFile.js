...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFileIds, orders, purchesedProductFileIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    orders = (_b.sent()).docs;
                    purchesedProductFileIds = orders.map(function (order) {
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFileIds, true), purchesedProductFileIds, true)
                            }
                        }];
            }
        });
